...
in vec4 fragCameraPosition;
in vec4 fragCameraNormal;
...
void main() {
  gPosition = fragCameraPosition;
  // You HAVE to give an alpha value of >0 or the whole thing is written as 0 (is this because of blending?)
  gNormal = vec4(fragCameraNormal.xyz, 1.f);
